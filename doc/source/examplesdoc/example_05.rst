...
Here you can see an example of a custom parameter, how to reload results and use them for analysis.
The structure loosely follows the suggestions from :ref:`more-on-concept`.
