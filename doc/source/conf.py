...
project = "pypet"
copyright = "2013-2026, Robert Meyer"

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents.
#
from pypet._version import __version__ as _pypet_version

# The short X.Y version.
version = ".".join(_pypet_version.split(".")[:2])
# The full version, including alpha/beta/rc tags.
release = _pypet_version
...
exclude_patterns = ["cookbook/concept.rst", "other/to_new_tree.rst", "contact_license.rst"]
...
latex_documents = [
    ("latex", "pypet.tex", "pypet Documentation", "Robert Meyer", "manual", True),
]
...
man_pages = [("index", "pypet", "pypet Documentation", ["Robert Meyer"], 1)]
...
# For read the docs - mock heavy dependencies
