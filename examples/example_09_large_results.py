...
traj = Trajectory(name="example_09_huge_data", filename=filename, overwrite_file=True)
...
traj.f_add_result(
    "huge_matrices", mat1=np.random.rand(100, 100, 100), mat2=np.random.rand(1000, 1000)
)
...
if (
    "monty" in traj.huge_matrices
    and "mat1" in traj.huge_matrices
    and "mat2" not in traj.huge_matrices
):
    val_mat1 = traj.huge_matrices.mat1[10, 10, 10]
    print("mat1 contains %f at position [10,10,10]" % val_mat1)
