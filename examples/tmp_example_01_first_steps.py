...
def multiply(traj):
    ...
    for irun in range(41):
        traj.f_add_result('a.b.sadsad.sadsads.sdad.z%s' % irun, np.random.rand(30), comment='Result of our simulation!')



# Create an environment that handles running
filename = os.path.join('experiments', 'example_01', 'HDF5','ttt4example_01.hdf5')
...
traj.f_explore(cartesian_product({'x':range(10), 'y':range(3)}))
