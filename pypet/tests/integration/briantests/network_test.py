...
try:
    ...
    from pypet.brian.parameter import BrianResult, BrianParameter, BrianMonitorResult
    from pypet.brian.network import NetworkComponent, NetworkAnalyser, NetworkRunner, \
        NetworkManager
