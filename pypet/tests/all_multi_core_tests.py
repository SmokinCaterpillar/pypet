...
big_suite_1 = discover_tests(lambda  class_name, test_name, tags: class_name in tests_include and 'shared' in tags)
...
big_suite_2 = discover_tests(lambda  class_name, test_name, tags: class_name in tests_include and 'shared' in tags)
...
big_suite_3 = discover_tests(lambda  class_name, test_name, tags: class_name in tests_include and 'shared' in tags)
...
big_suite_4 = discover_tests(lambda  class_name, test_name, tags: class_name in tests_include and 'shared' in tags)
